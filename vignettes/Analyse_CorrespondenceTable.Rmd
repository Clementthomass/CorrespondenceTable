...
```{r}
result2 <-analyseCorrespondenceTable(AB = system.file("extdata", "ExempleAnnexe.csv", package = "correspondenceTables"), A =  NULL , longestAcodeOnly = TRUE ,
                             B = NULL,
                             longestBcodeOnly = TRUE, CSVcorrespondenceInventory = NULL, CSVcorrespondenceAnalysis = NULL)
