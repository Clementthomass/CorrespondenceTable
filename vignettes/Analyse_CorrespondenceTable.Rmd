...
longestAcodeOnly longestBcodeOnly will be set to TRUE here to have only the retain only the lowest level. 
...
result2 <-analyseCorrespondenceTable(AB = (system.file("extdata", "ab_data.csv", package = "correspondenceTables")),
                             ...
                             longestBcodeOnly = c(1,5), CSVcorrespondenceInventory = NULL, CSVcorrespondenceAnalysis = NULL)
