...
The following code is used to retrieve the french,Deutch and bulgarian NACE2  classification from static data:
...
result_bg = retrieveClassificationTable(localData = system.file("extdata","nace2_bg.csv", package = "correspondenceTables"))

result_fr = retrieveClassificationTable(localData = system.file("extdata","nace2_fr.csv", package = "correspondenceTables"))

result_de = retrieveClassificationTable(localData = system.file("extdata","nace2_de.csv", package = "correspondenceTables"))
...
To following code is used to retrieve the French Deutsch and Bulgarian correspondence table  between NACE2 and CPA21 from static data :
```{r, results = "hide"}
...
result_fr = retrieveCorrespondenceTable(showQuery = F,localData = system.file("extdata","NACE2_CPA21_fr.csv",package = "correspondenceTables"))

result_de = retrieveCorrespondenceTable(showQuery = F,localData = system.file("extdata","NACE2_CPA21_de.csv",package = "correspondenceTables"))

result_bg = retrieveCorrespondenceTable(showQuery = F,localData = system.file("extdata","NACE2_CPA21_bg.csv",package = "correspondenceTables"))
